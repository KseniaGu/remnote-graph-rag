...
TEST_SOURCES = [
    "почитать про деревья решений",
    "AI Expert Roadmap !!!!",
    "Про историю КЗ быстренько глянуть (как там развивались clip, dalle, diffusions etc)",
    "[GRPO Explained] DeepSeekMath: Pushing the Limits of Mathematical Reasoning in Open Language Models",
    "Mixed Precision _ by Benjamin Warner",
    "Building Effective AI Agents _ Anthropicпослушать ноутбук",
    "Measuring Massive Multitask Language Understanding",
    "Про оптимайзеры тоже почитать",
    ...
    "Word Embeddings",
    "Paper page - Rope to Nope and Back Again_ A New Hybrid Attention Strategy",
    "Algorithms basics",
    "Линейную алгебру ещё раз прогнать всю и законспектировать (обратные матрицы, svd etc  со сложностями)",
    "Backpropagation",
    "Super study guide transformers and llm ADD NOTES",
    "почитать про DPO, PPO, GRPO",
]
MIN_RELEVANCE_SCORE = (
...
TITLE_MAX_LENGTH = 45
VISUALIZATION_EMPTY_CONTEXT = "Visualization empty: no focused graph data found"

# CACHE & MEMORY
CACHE_SCHEMA_VERSION = 1
DEFAULT_CACHE_COLLECTION_NAME = "quick_action_answer_cache"
DEFAULT_TTL_SECONDS = 7 * 24 * 60 * 60
SESSION_MEMORY_SCHEMA_VERSION = 1
DEFAULT_SESSION_MEMORY_COLLECTION_NAME = "chat_session_memory"
DEFAULT_SESSION_MEMORY_TTL_SECONDS = 30 * 24 * 60 * 60
DEFAULT_RECENT_MESSAGE_LIMIT = 4
DEFAULT_MAX_MESSAGE_CHARS = 1200
DEFAULT_SUMMARY_MAX_CHARS = 2200
CACHED_AGENT_REPLAY_LATENCY = 0.5
CACHED_TOKENS_REPLAY_LATENCY = 0.02
