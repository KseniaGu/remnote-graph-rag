...
class KnowledgeGraphIndexer:
    ...
    def load_index(self, *, ensure_embeddings: bool = False):
        """Loads a prepared PropertyGraphIndex without mutating it by default.

        Args:
            ensure_embeddings: Generate missing embeddings after loading. This is
                intended for explicit offline build or migration workflows only.
        """
        implicit_extractor = ImplicitPathExtractor()
